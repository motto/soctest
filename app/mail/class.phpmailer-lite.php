...
$email->SetFrom('you@yourdomain.com', 'Your Name');
$email->AddAddress("josh@example.net", "Josh Adams");
 ...
 */
 ...
 function mail_kuld($cim,$uzenet,$kuldocim='email@infolapok.hu',$subject='',$kuldonev='',$cimnev='')
 {
...
$mail->Body    = $uzenet;
	...
	{$hiba='sikeres';}
mail_ment($cim,$uzenet,$kuldocim,$subject,$kuldonev,$cimnev,$hiba);	
return $hiba;
}
...
class PHPMailerLite {
   ...
   * email to multipart/alternative.  This body can be read by email
  ...
  /**
   * Method to send email: ("email", or "sendmail").
   * @var string
   */
  public $Mailer            = 'email';
  ...
  /**
   * Sets Mailer to send message using PHP email() function.
   * @return void
   */
  ...
  /**
   * Adds a "Cc" address.
   * Note: this function works with the SMTP mailer on win32, not with the "email" mailer.
   * @param string $address
   * @param string $name
   * @return boolean true on success, false if address already used
   */
 ...
 */
  ...
  /**
   * Sends email using the $Sendmail program.
  ...
  /**
   * Sends email using the PHP email() function.
   * @param string $header The message headers
   * @param string $body The message body
   * @access protected
   * @return bool
  ...
  */
  function SetLanguage($langcode = 'en', $lang_path = 'language/') {
    ...
    if ($langcode != 'en') { //There is no English translation file
      $l = @include $lang_path.'phpmailer.lang-'.$langcode.'image_manipulator.php';
    }
  ...
  */
  ...
  public function CreateHeader() {
    ...
    // To be created automatically by email()
  ...
  /**
   * Returns a formatted email line.
   * @access public
   * @return string
   */
  ...
  */
  ...
  /**
   * Correctly encodes and wraps long multibyte strings for email headers
